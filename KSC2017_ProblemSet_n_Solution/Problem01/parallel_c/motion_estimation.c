...
void MotionEstimation(unsigned char *pImage, int nWidth, int nHeight, int nSearchRange, int *nMV, int nStaFrameNum, int nEndFrameNum, int nOffset)
{
	...
	for (i = nStaFrameNum; i < nEndFrameNum - 1; i++)
	{
