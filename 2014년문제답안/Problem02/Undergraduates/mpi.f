c234567
      ...
      do j=1, np
         do i = j+1, np
            ...
            if(dist .gt.0) potential = potential + 1.d0/dble(dist)
         enddo
      enddo
      end
      ...
      integer iseed
      common /seed/ iseed
      if(istep-1 .lt. niter/10) then
         getrandomnp = (3000+5000*ran2(iseed))
      else
         getrandomnp = (100*ran2(iseed))
      endif
      return
      end
      program mpi_c
...
20             continue
     ...
     &            mstatus, IERROR)
      ...
      if(myid.eq.0) print *, 'total potential is', totpotent, 'in ', 
     &            (time2-time1),' seconds'
