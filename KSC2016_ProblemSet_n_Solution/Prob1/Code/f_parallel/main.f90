...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	istart = N_PT / nprocs * rank + 1
	iend   = N_PT / nprocs * (rank+1)
    do iter = 0, 99
        call assignment_step(kmeans, pt, istart, iend, kindex)
        kmeans_old = kmeans
        call update_step(kmeans, pt, istart, iend, kindex)
